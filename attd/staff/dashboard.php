...
$user = $_SESSION['staff_session']; //assigns user value
...
$sql = "SELECT *  FROM attendance INNER JOIN staff ON attendance.staff_id = staff.id WHERE attendance.staff_id = '$id';";
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="attendance_scan.php"><i class="fa fa-credit-card"></i> Scan</a></li>

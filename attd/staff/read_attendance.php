...
$sql = "SELECT attendance.id, attendance.date, staff.name, attendance.checkin, attendance.checkout, attendance.working_hours  FROM attendance INNER JOIN staff ON attendance.staff_id = staff.id WHERE attendance.staff_id = '$id';";

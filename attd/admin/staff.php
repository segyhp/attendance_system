...
<div class="content-wrapper">
    ...
    <section class="content">
       ...
       <div class="box">
        ...
        <div class="box-body">
            <button type="submit" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Add Staff</button>
            <br>
            <br>
            <table id="table_staff" class="table table-bordered table-striped tabel-hover data-table">
                <thead>
                <tr>
                    <th>No</th>
                    <th>UID</th>
